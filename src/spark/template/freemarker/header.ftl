...
<body>
    <div id="main">
        <div id="header">
   <!--<a href="#" class="logo"><img src="/static/img/logo.png" width="101" height="29" alt="" /></a> -->
            <ul id="top-navigation">
            <#list listaCategorias as lc>
                    <li><a href='/${lc}' <#if lc == categoriaAtual> class='active'</#if>  >${lc}</a></li>
              </#list>
            </ul>
        </div>
        <div id="middle">
...
<!--                    <a href="#" class="button">ADD NEW </a> -->
                    <h1>${titulo}</h1>
                    <div class="breadcrumbs">${descricaoView}<!--<a href="">the fock is this</a> / <a href="">dafuq</a>--></div>
                </div>
